...
const labels: Cs2ClientListenerDashboardLabels = {
  ...
  tabSwitchHint: "7 = Stream | 8 = Game | 9 = Performance",
  yes: "yes",
  no: "no",
  ...
  perfProcessRunning: "CS2 process",
  perfProcessPid: "PID",
  perfCpuPercent: "CPU %",
  perfWorkingSetMb: "Working set",
  perfGpuUtilization: "GPU util %",
  perfGpuDedicatedMb: "GPU dedicated VRAM",
  perfGpuSharedMb: "GPU shared memory",
  perfFpsSmoothed: "FPS (smoothed)",
  perfFrametimeMs: "Frametime",
  perfPresentChainError: "Present chain",
};
