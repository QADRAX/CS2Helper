 ...
 */
export function processTickDomain(state, memory, payload, timestamp) {
    const nextState = cloneState(state);
    const nextMemory = { ...memory, players: { ...memory.players } };
    const events = [];
    ...
    const quality = evaluateSnapshotQuality(snapshot, nextState.streamWatermarks.lastReliableTimestamp);
