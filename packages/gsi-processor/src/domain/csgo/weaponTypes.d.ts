...
export interface Pistol {
    type: "Pistol";
    name: "weapon_deagle" | "weapon_elite" | "weapon_fiveseven" | "weapon_glock" | "weapon_cz75a" | "weapon_hkp2000" | "weapon_p250" | "weapon_revolver" | "weapon_tec9" | "weapon_usp_silencer";
    paintkit: string;
...
export interface SubmachineGun {
    type: "Submachine Gun";
    name: "weapon_mac10" | "weapon_bizon" | "weapon_mp5sd" | "weapon_mp7" | "weapon_mp9" | "weapon_p90" | "weapon_ump45";
    paintkit: string;
    ammo_clip: number;
    ammo_clip_max: number;
    ammo_reserve: number;
...
export interface Rifle {
    type: "Rifle";
    name: "weapon_ak47" | "weapon_aug" | "weapon_famas" | "weapon_galilar" | "weapon_m4a1" | "weapon_m4a1_silencer" | "weapon_sg556";
    paintkit: string;
    ammo_clip: number;
    ammo_clip_max: number;
    ammo_reserve: number;
...
export interface Grenade {
    type: "Grenade";
    name: "weapon_smokegrenade" | "weapon_decoy" | "weapon_hegrenade" | "weapon_incgrenade" | "weapon_molotov";
    paintkit: string;
    ammo_reserve: number;
    state: WeaponState;
}
/** Any supported weapon shape from GSI inventory. */
export type Weapon = Knife | Pistol | Bomb | Grenade | MachineGun | Rifle | Shotgun | SniperRifle | SubmachineGun;
/**
