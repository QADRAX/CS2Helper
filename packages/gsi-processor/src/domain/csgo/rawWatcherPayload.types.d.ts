import type { ObservatorSlotType, PhaseMap, PhaseRound, PlayerActivityType, RoundWinningType, TeamType } from "./phases";
...
export type WatcherPayload = ClientWatcherPayload | SpectatorWatcherPayload | DedicatedServerWatcherPayload;
export {};
