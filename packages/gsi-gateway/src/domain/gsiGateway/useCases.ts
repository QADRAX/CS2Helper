...
export type IngestGsiTickUseCase = UseCase<[gameState: CS2GameState, rawBody: string], void>;
...
/** Use case that subscribes to raw JSON ticks. */
export type SubscribeRawTicksUseCase = UseCase<[(raw: string) => void], () => void>;
...
export interface GsiGatewayUseCasesMap {
  ...
  subscribeRawTicks: SubscribeRawTicksUseCase;
}
